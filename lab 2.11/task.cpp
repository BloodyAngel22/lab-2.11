...
//символа.*/
//
//int remove_numbers(char* str, char* storageStr,int* strNumeric ,int counter) {
...
//	}*/
//	char* pointer;
//	pointer = strchr(str, '1');
//	for (int j = 0; j < counter; j++) {
//		if (pointer == NULL) break;
//		if (str[j] == *pointer) 
//			pointer = strchr(pointer + 1, '1');
//		if (pointer != NULL) {
//			storageStr[j] = str[j];
//		}
//	}
...
//	{
//	case 1:
//		storage = remove_numbers(str, storageStr, strNumeric,counter);
